...
from Prediction.Util.normalizer_for_prediction import PNormalizer
...
class PData:
    ...
    def __init__(self, root_path, file_name, input_dim, output_dim, upper_norm=-1, lower_norm=1, s=[], o=[]):
        ...
        # data normalization -------------------------------------------------------------------------------------------
        self.normalizer = PNormalizer(root_path=self.root_path, input_dim=input_dim, output_dim=output_dim,
